 ...
 * {@link RwtApplicationConfiguration}, which uses it to register the entry point.
 * <p>
 * A Grails RWT application can have multiple entrypoint configured in the Config.groovy file.
 *
